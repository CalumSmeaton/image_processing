...
def limit(pixel_val, quantity):
    if(pixel_val + quantity > 255):
       # print("too high")
        return 255
    elif(pixel_val + quantity < 0):
        return 0
    else:
        return (pixel_val + quantity)

def intensify(pixel, quantity):
   # print("called intensify")
    r_val = limit(pixel[0], quantity)
   # print(r_val)
    g_val = limit(pixel[1], quantity)
   # print(g_val)
    b_val = limit(pixel[2], quantity)
   # print(b_val)
